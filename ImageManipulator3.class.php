...
class ImageManipulator3 extends Wire
{
    ...
    // Construct & Destruct the ImageManipulator3 for a single image
        ...
        public function __construct($entryItem = null, $options = [], $bypassOperations = false)
        {
            ...
            } else if (is_string($entryItem) && is_file($entryItem)) {
                $this->entryItem = 'file';
                $this->filename = $entryItem;
                $this->isOriginal = false;
            } else if ($this->isResourceGd($entryItem)) {
...
//            $this->modified = true;  // this is from ImageResizer, don't know if we can use this here
        ...
        public function removePimVariations()
        {
            ...
            $variations = $this->getPimVariations();
            foreach($variations as $variation) {
                @unlink($variation->filename);
            }
            // reset cached variations
        ...
        public function getPimVariations($forceRefresh = true)
        {
            ...
            $this->variations = $this->pageimage->getVariations(array('suffix' => 'pim2'));
    ...
    **/
    class hn_SizeCalc
    {
        ...
        /** Mit der Methode down werden Werte (falls sie groesser sind als die MaxWerte) verkleinert.
          ...
          * @public
          **/
        public function down(&$a,&$b,$a_max,$b_max)
        {
            $this->a = 0;
            $this->b = 0;
        ...
        /** Mit der Methode up werden Werte (falls sie groesser sind als die MaxWerte) verkleinert
          ...
          * @public
          **/
        public function up(&$a,&$b,$a_max,$b_max)
        {
        ...
        /** @private **/
        private function _diffProzent($ist,$soll)
        {
